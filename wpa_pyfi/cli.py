...
def arg_parser():
    ...
    parser_show.add_argument('netname', help=network_help, metavar='NETNAME', required=False, default=None)
    ...
    parser_add.add_argument('netname', help=network_help, metavar='NETNAME', required=False, default=None)
    ...
    parser_delete.add_argument('netname', help=network_help, metavar='NETNAME', required=False, default=None)
    ...
    parser_connect.add_argument('netname',
                                ...
                                metavar='NETNAME', required=False, default=None)
